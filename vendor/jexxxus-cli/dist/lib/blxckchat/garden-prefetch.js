 ...
 */
export async function prefetchGardenContext(userPrompt, options) {
    ...
    if (needsDocs) {
        blocks.push("", "### JEXXXUS | Docs (docs.jexxx.us)", "Public reference library for architecture, CLI, and platform docs. Summarize from " +
    ...
    if (tvSearch || veilSearch || verses.length > 0) {
        blocks.push("For TV/VEIL/scripture: do not call bible_query with book names only or action=chapters. " +
...
//# sourceMappingURL=garden-prefetch.js.map