...
export function getChromeDigestPath() {
    return `${getCredentialsDir()}/chrome-digest.txt`;
}
function writeSnapshotFile(target, text) {
...
export function writeClipboardOsc52(text) {
 ...
 */
function nativeClipboardMayNotReachHostTerminal() {
    return Boolean(process.env.JEXXXUS_EMBEDDED === "1" ||
        process.env.TMUX ||
        process.env.STY ||
        process.env.SSH_TTY ||
...
//# sourceMappingURL=tui-snapshot.js.map