 ...
 */
export const accountQueryTool = {
    name: "account_query",
    description: "Query the signed-in user's private JEXXXUS vault data (BLXCKBOOK contacts, journal, " +
    ...
    async execute(args) {
        ...
        const target = targetRaw === "blxckbook" || targetRaw === "nxt" || targetRaw === "auto"
            ? targetRaw
            : "auto";
        const queryArgs = { action, target };
