...
import { fetchOpenAiCompatibleModels, listModelsForProvider, resolveModelsEndpoint, supportsLiveModelDiscovery, } from "../lib/blxckchat/providers/models.js";
...
describe("provider model discovery", () => {
    test("resolveModelsEndpoint normalizes base URLs", () => {
        assert.equal(resolveModelsEndpoint("https://opencode.ai/zen/v1"), "https://opencode.ai/zen/v1/models");
        assert.equal(resolveModelsEndpoint("https://api.deepseek.com"), "https://api.deepseek.com/v1/models");
    });
...
//# sourceMappingURL=blxckchat-providers-models.test.js.map